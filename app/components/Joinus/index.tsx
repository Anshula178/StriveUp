        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    ...
                    <p className="text-lightblack text-base font-normal max-w-3xl mx-auto">Ready to grow your digital presence? Join us and unlock powerful solutions 
                        that help your business scale faster and smarter. Stay ahead with 
                        innovation, creativity, and expertise at every step.</p>
                </div>
